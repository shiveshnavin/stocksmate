...
async function start(params) {
    ...
    //     "exchange": "NFO"    
    // })
    stockData = { instrument_token: '256265', tradingsymbol: 'NIFTY' };
    let formatDate = 'YYYY-MM-DD+HH:mm:ss'
    // let day = parseInt(process.argv[2]) || 20;
    let from = moment(`2022-01-27T09:15:00`)
    let to = moment();//`2022-01-21T15:30:00`
   // to = moment(`2022-01-18T15:30:00`);

    let dur = process.argv[2] || 'day';
