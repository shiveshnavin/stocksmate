...
const {
  ...
  marketpayload,
  OrderValidityEnum
} = require("5paisajs/const");
const { AES128Encrypt, AES256Encrypt } = require("5paisajs/utils");
...
function FivePaisaClient(conf) {
  ...
  const ORDER_PLACEMENT_ROUTE = `${BASE_URL}/PlaceOrderRequest`;
